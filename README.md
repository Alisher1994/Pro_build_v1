...
- **Prisma ORM**
- **Облачная База Данных**: PostgreSQL (Развернута на **Railway.app**). 
  - ⚠️ *Важно*: Система использует внешнюю облачную БД. Данные НЕ сохраняются в локальные файлы (SQLite/JSON), что обеспечивает доступность проекта из любой точки мира.
