...
const SettingsManager = {
    ...
    async showStaffManagement(projectId, initialState = {}) {
        ...
        try {
            ...
            // Events ниже переназначаются в internalRender, лишний делегат убран.
        ...
        try {
            ...
            contentArea.innerHTML = `
                <div style="background: var(--white); border: 1px solid var(--gray-300); border-radius: 12px; padding: 40px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
                    <div style="display: grid; grid-template-columns: 1fr 380px; gap: 32px; margin-bottom: 24px; align-items: start;">
                        <div>
